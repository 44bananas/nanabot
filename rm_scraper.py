                            ...
                            if str(negstat).lower() in filters[y]['neg'] or filters[y]['neg'] == "1":
                                ...
                                if grades == {}:
                                    ...
                                    for z in grades:
                                        ...
                                        description += str(grades[z]['weapon']).title() + " "+"\n"+pos1_color + str(stat1name)+ " "+ bane_patch.back_to_front(str(stat1name),str(riven_data[x]['pos_val1']))+ " "+ " ("+ str(pos_grade1_1)+ "%, " + str(pos_grade1_2)+ ") " + " \n"+pos2_color+ str(stat2name)+ " "+ bane_patch.back_to_front(str(stat2name),str(riven_data[x]['pos_val2'])) + " "+ " ("+str(pos_grade2_1)+ "%, "+ str(pos_grade2_2)+ ") " + " \n"+pos3_color+ str(stat3name)+ " "+ bane_patch.back_to_front(str(stat3name),str(riven_data[x]['pos_val3']))+ " "+   " ("+str(pos_grade3_1)+ "%, "+ str(pos_grade3_2) + ") " +" \n"+neg_color+ str(negstat)+ " "+ bane_patch.back_to_front(str(negstat),str(riven_data[x]['negval'])) + " "+" ("+str(neg_grade1)+ "%, "+ str(neg_grade2) + ")\n" + "\n"
                                # print(description)
